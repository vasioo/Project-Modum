...
namespace Modum.DataAccess.Migrations
{
    ...
    [Migration("20240320193320_changingWorkerEntities")]
    partial class changingWorkerEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modum.Models.BaseModels.Models.BaseStructure.MainCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fa24b471-4b1f-4238-a12b-420786e02496"),
                            Name = "Men"
                        },
                        new
                        {
                            Id = new Guid("998eec9e-3fa3-49a6-bee9-d3bb7308acd0"),
                            Name = "Women"
                        },
                        new
                        {
                            Id = new Guid("360a9039-f479-499d-ac08-6adf7dcc15ee"),
                            Name = "Boys"
                        },
                        new
                        {
                            Id = new Guid("fb672249-6922-420c-864b-b6b1a88bddc9"),
                            Name = "Girls"
                        });
                });
            ...
            modelBuilder.Entity("Modum.DataAccess.MainModel.Worker", b =>
                {
                    b.HasOne("Modum.DataAccess.MainModel.ApplicationUser", "AppUser")
                        .WithMany()
