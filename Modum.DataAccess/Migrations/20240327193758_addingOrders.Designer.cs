...
namespace Modum.DataAccess.Migrations
{
    ...
    [Migration("20240327193758_addingOrders")]
            ...
            modelBuilder.Entity("Modum.Models.BaseModels.Models.BaseStructure.MainCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("59cfe593-0101-475b-b361-3b9fcc29af89"),
                            Name = "Men"
                        },
                        new
                        {
                            Id = new Guid("0b831f59-6d27-4341-90b5-715147c159eb"),
                            Name = "Women"
                        },
                        new
                        {
                            Id = new Guid("532b05c9-0a73-424d-858c-c7ff3ecdcb4e"),
                            Name = "Boys"
                        },
                        new
                        {
                            Id = new Guid("33e0742f-d5b8-4293-8c81-d6d6aa09af63"),
                            Name = "Girls"
                        });
                });
