...
namespace Modum.DataAccess.Migrations
{
    ...
    [Migration("20240328152232_changingOrders")]
    partial class changingOrders
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Modum.Models.BaseModels.Models.BaseStructure.MainCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c99ad0b2-a3bf-4c4a-a480-e625e1bd57d3"),
                            Name = "Men"
                        },
                        new
                        {
                            Id = new Guid("b8dd9356-1e97-44a1-b732-eb74d2564b64"),
                            Name = "Women"
                        },
                        new
                        {
                            Id = new Guid("fbf22f65-fe99-4ba6-bfd4-72818590f210"),
                            Name = "Boys"
                        },
                        new
                        {
                            Id = new Guid("9599104c-13f7-4199-b4c1-d07b5fd647e5"),
                            Name = "Girls"
                        });
                });
