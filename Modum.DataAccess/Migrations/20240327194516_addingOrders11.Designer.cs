...
namespace Modum.DataAccess.Migrations
{
    ...
    [Migration("20240327194516_addingOrders11")]
    partial class addingOrders11
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Modum.Models.BaseModels.Models.BaseStructure.MainCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b2c14561-a4d8-4fd2-9957-2ebedbafa325"),
                            Name = "Men"
                        },
                        new
                        {
                            Id = new Guid("89b19aa4-7181-4899-b59f-6fa1be711588"),
                            Name = "Women"
                        },
                        new
                        {
                            Id = new Guid("5ab46b4e-d90d-44a4-9d0d-0f6962afc623"),
                            Name = "Boys"
                        },
                        new
                        {
                            Id = new Guid("b056b89b-c5a2-48dd-ba08-f28d7e0001c6"),
                            Name = "Girls"
                        });
                });
            ...
            modelBuilder.Entity("Modum.Models.BaseModels.Models.PaymentStructure.OrderStatus", b =>
                {
            ...
            modelBuilder.Entity("Modum.Models.BaseModels.Models.PaymentStructure.OrderStatus", b =>
                {
                    b.HasOne("Modum.Models.BaseModels.Models.PaymentStructure.Order", "Order")
                        .WithMany()
