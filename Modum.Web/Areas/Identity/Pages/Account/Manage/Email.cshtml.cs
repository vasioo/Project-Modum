...
namespace Modum.Web.Areas.Identity.Pages.Account.Manage
{
    public class EmailModel : PageModel
    {
        ...
        public EmailModel(
            ...
            IEmailSender emailSender, IConfiguration configuration, IEmailSenderService emailSenderService)
        {
        ...
        public async Task<IActionResult> OnPostSendVerificationEmailAsync()
        {
            ...
            _emailSenderService.SendEmail(user.Email,emailBody,"Email Confirmation");
            return RedirectToPage();
        }
    }
}
